...
function getInfoList(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+"/GssCityController/getCityListByProvinceCode.act?provinceCode=<%=provinceCode%>",
		pagination:true,
		singleSelect:false,
...
<body onload="doInit()" style="overflow: hidden; font-size: 12px">
	...
	<div id="toolbar">
		...
		<div style="text-align: left; margin-bottom: 10px; margin-left: 10px;">
			<button class="btn btn-success" onclick="addOrUpdateInfo(0)">添加城市</button>
			&nbsp;&nbsp;
		</div>
	</div>
</body>
