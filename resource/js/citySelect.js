...
Vcity.allCity =['北京|beijing|bj','上海|shanghai|sh','成都|chengdu|cd','重庆|chongqing|cq','大连|dalian|dl','广州|guangzhou|gz','哈尔滨|haerbin|heb',
                '杭州|hangzhou|hz','济南|jinan|jn','南京|nanjing|nj', '青岛|qingdao|qd','深圳|shenzhen|sz','沈阳|shenyang|sy','天津|tianjin|tj', '武汉|wuhan|wh','西安|xian|xa',
                '鞍山|anshan|as','安阳|anyang|ay','澳门|aomen|am','包头|baotou|bt','保定|baoding|bd','宝鸡|baoji|bj',
                '北海|beihai|bh','蚌埠|bengbu|bb','长春|changchun|cc','长沙|changsha|cs','常州|changzhou|cz',
                '潮州|chaozhou|cz','承德|chengde|cd','大庆|daqing|dq','大同|datong|dt','丹东|dandong|dd','东莞|dongguan|dg',
                '佛山|foushan|fs','福州|fuzhou|fz','抚顺|fushun|fs','桂林|guilin|gl',
                '贵阳|guiyang|gy','海口|haikou|hk','邯郸|handan|hd','合肥|hefei|hf',
                '呼和浩特|huhehaote|hhht','湖州|huzhou|fz', '黄山|huangshan|hs','惠州|huizhou|hz','吉林|jilin|jl',
                '嘉兴|jiaxing|jx','江门|jiangmen|jm','金华|jinhua|jh','九江|jiujiang|jj','开封|kaifeng|kf',
                '昆明|kunming|km','拉萨|lasa|ls','兰州|lanzhou|lz','乐山|leshan|ls','丽江|lijiang|lj','连云港|lianyungang|lyg','柳州|liuzhou|lz',
                '洛阳|luoyang|ly','绵阳|mianyang|my','南昌|nanchang|nc','南宁|nanning|nn','南平|nanping|np',
                '南通|nantong|nt','宁波|ningbo|nb','莆田|putian|pt','齐齐哈尔|qiqihaer|qqhe','秦皇岛|qinhuangdao|qhd',
                '泉州|quanzhou|qz','日照|rizhao|rz','三亚|sanya|sy','汕头|shantou|st',
                '绍兴|shouxing|sx','石家庄|shijiazhuang|sjz','苏州|suzhou|sz','台州|touzhou|tz','泰安|taian|ta',
                '泰州|taizhou|tz','太原|taiyuan|ty','唐山|tangshan|ts','威海|weihai|wh','潍坊|weifang|wf','乌鲁木齐|wulumuqi|wlmq',
                '芜湖|wuhu|wh', '无锡|wuxi|wx','温州|wenzhou|wz','西宁|xining|xn','厦门|xiamen|xm',
                '咸阳|xianyang|xy','襄樊|xiangfan|xf','香港|xiangguang|xg','徐州|xuzhou|xz','烟台|yantai|yt',
                '延安|yanan|ya', '扬州|yangzhou|yz', '宜昌|yichang|yc','银川|yinchuan|yc','岳阳|yueyang|yy',
                '湛江|zhanjiang|zj','漳州|zhangzhou|zz','肇庆|zhaoqing|zq', '镇江|zhengjiang|zj','郑州|zhengzhou|zz',
                '中山|zhongshan|zs','舟山|zhoushan|zs','珠海|zhuhai|zh','株洲|zhuzhou|zz','淄博|zibo|zb'
                ];
